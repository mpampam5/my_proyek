<div class="page-content-wrapper">
  <div class="container-fluid">
    <div class="col-md-10 mx-auto mb-5">
      <div class="card">
        <div class="card-body">
          <form class="" action="<?=site_url("usrp/master_proyek/action/$kode")?>" id="form" autocomplete="off">
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" name="alamat" id="alamat" rows="3" cols="80" placeholder="Jl. exmplae. kecamatan , Kelurahan , Nomor."></textarea>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  <input type="file" name="upload-file2" id="upload-file2" style="display:none"   accept="image/*">
                    <div class="bootstrap-filestyle input-group">
                      <input type="text" class="form-control bg-white" id="value-file2" placeholder="Upload Berkas" readonly>
                      <span class="group-span-filestyle input-group-append" tabindex="0">
...
function loadKabupaten()
{
    ...
    if (provinsi!="") {
      $.ajax({
          type:'GET',
          url:"<?php echo base_url(); ?>usrp/master_proyek/jsonkabupaten",
          data:"id=" + provinsi,
...
$("input[name='ujroh_penyelenggara']").TouchSpin({
      ...
      $(function () {
            ...
            fileupload.change(function () {
                ...
                $.ajax({
                   url: '<?=site_url("usrp/master_proyek/do_upload/$kode")?>',
                   dataType: 'json',
                   cache: false,
                   contentType: false,
                   processData: false,
