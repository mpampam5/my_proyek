          ...
          <div class="card m-b-30">
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label for="example-search-input" class="col-sm-3 col-form-label">Kategori</label>
                    <div class="col-sm-9">
                        <input class="form-control" type="text" name="kategori" id="kategori" value="<?=$kategori?>">
                    </div>
                </div>


                <?php if ($button == "update"): ?>
                  <input class="form-control" type="hidden" name="kategori_lama" id="kategori_lama" value="<?=$kategori?>">
                <?php endif; ?>
