<div class="wrapper">
  <div class="container-fluid">
    <div class="col-md-10 mx-auto mb-5">
      <div class="card">
        <div class="card-body">
          <form class="" action="<?=site_url("backend/Cara_jadi_penerima_dana/action")?>" id="form" autocomplete="off">
            <div class="form-group">
              <label for="">Deskripsi</label>
              <textarea class="form-control" id="elm1" rows="5" cols="80" placeholder="Deskripsi"><?=config_system("cara-jadi-penerima-dana","deskripsi")?></textarea>
              <input type="hidden" id="deskripsi" name="deskripsi" value="<?=config_system("cara-jadi-penerima-dana","deskripsi")?>">
            </div>
