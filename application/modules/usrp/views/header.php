                ...
                <div class="sidebar-inner slimscrollleft">
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li>
                                <a href="<?=site_url("usrp/deposit")?>" class="waves-effect"><i class="fa fa-file"></i><span> Deposit </span></a>
                            </li>

                            <li>
                                <a href="<?=site_url("usrp/withdraw")?>" class="waves-effect"><i class="fa fa-file"></i><span> Withdraw </span></a>
                            </li>

                            <li>
                                <a href="<?=site_url("usrp/profile")?>" class="waves-effect"><i class="fa fa-user"></i><span> Profile </span></a>
                            </li>
