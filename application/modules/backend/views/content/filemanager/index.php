          ...
          <div class="card m-b-30">
            <div class="card-body">
              <div class="m-b-10 text-left m-l-15 m-r-15">
                <div class="row">
                  <div class="col-sm-6">
                    <a href="<?=site_url("backend/filemanager/add")?>" id="add" class="btn btn-sm btn-success"><i class="fa fa-image"></i> Upload Image</a>
...
//datatables
  table = $('#table').DataTable({
      ...
      "ajax": {
          "url": "<?php echo site_url("backend/filemanager/json")?>",
          "type": "POST",
          "data": function(data){
