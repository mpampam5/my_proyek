                ...
                <div class="col-md-12 col-xl-12 animated fadeInRight delay-3s">
                  <div class="card m-b-10">
                    <div class="mb-2 card-body text-muted">
                        <a href="<?=site_url("backend/deposito")?>" class="btn btn-md btn-secondary btn-block"><i class="fa fa-file"></i> Daftar Deposito</a>
                        <hr>
                        <?php if ($dt->status=="process"){ ?>
                          ...
                          <form class="m-t-10" action="<?=site_url("backend/deposito/action")?>" id="form">
