<div class="page-content-wrapper">
  <div class="container-fluid">
    <div class="col-md-10 mx-auto mb-5">
      <div class="card">
        <div class="card-body">
          <form id="form" action="<?=site_url("user/profile/form_foto_action")?>" autocomplete="off">
          ...
          <div class="form-group">
            ...
            <div class="text-right mt-5">
              <a class="btn btn-md btn-light" href="<?=site_url("user/profile")?>" id="kembali">Kembali</a>
              <button type="submit" name="button" class="btn btn-md btn-primary">Selesai</button>
            </div>
          </form>
...
$(function () {
      ...
      fileupload.change(function () {
          ...
          $.ajax({
             url: '<?=site_url("user/profile/do_upload")?>',
             dataType: 'json',
             cache: false,
             contentType: false,
             processData: false,
