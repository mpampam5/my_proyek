                ...
                <div class="col-md-12 col-xl-12 animated fadeInRight delay-3s">
                  <div class="card m-b-10">
                    <div class="mb-2 card-body text-muted">
                        <a href="<?=site_url("backend/withdraw_usrp")?>" class="btn btn-md btn-secondary btn-block"><i class="fa fa-file"></i> Daftar withdraw</a>
                        <hr>
                        <?php if ($dt->status=="process"){ ?>
                          <form class="m-t-10" action="<?=site_url("backend/withdraw_usrp/action")?>" id="form">
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                          <table class="table tabless table-borderless">
                            <tr>
                              <th>ID-REG</th>
                              <td>: <a href="<?=site_url("backend/penerima_dana/detail/".enc_url($dt->id_penerima_dana))?>" target="_blank"><i class="fa fa-link"></i> <?=$dt->id_reg?></a></td>
                            </tr>
