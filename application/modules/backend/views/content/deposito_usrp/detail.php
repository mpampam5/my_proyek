                ...
                <div class="col-md-12 col-xl-12 animated fadeInRight delay-3s">
                  <div class="card m-b-10">
                    <div class="mb-2 card-body text-muted">
                        <a href="<?=site_url("backend/deposito_usrp")?>" class="btn btn-md btn-secondary btn-block"><i class="fa fa-file"></i> Daftar Deposito</a>
                        <hr>
                        <?php if ($dt->status=="process"){ ?>
                          <div class="alert alert-info bg-info text-white" role="alert">
                              <strong>PENTING!</strong> Pastikan <i>Amount Transfer</i> sama dengan <i>Nominal</i> yang tertera pada <i>Bukti Transfer</i>.
                          </div>


                          <form class="m-t-10" action="<?=site_url("backend/deposito_usrp/action")?>" id="form">

                            <input type="hidden" name="id_act" id="id_act" value="<?=enc_url($dt->id_deposito)?>">
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                          <table class="table tabless table-borderless">
                            <tr>
                              <th>ID-REG</th>
                              <td>: <a href="<?=site_url("backend/pendana/detail/".enc_url($dt->id_penerima_dana))?>" target="_blank"><i class="fa fa-link"></i> <?=$dt->id_reg?></a></td>
                            </tr>
                        ...
                        <div class="col-lg-12">
                          <hr>
                          <h5 style="font-size:15px;color:#222222">TRANSFER KE REKENING:</h5>
                          <p><span class="text-warning">[<?=rekening($dt->id_rekening,"nama_bank")?>]</span> <?=rekening($dt->id_rekening,"nama_rekening")?> - <?=rekening($dt->id_rekening,"no_rekening")?></p>
                        </div>
